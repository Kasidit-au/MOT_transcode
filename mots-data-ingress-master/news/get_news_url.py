...
if __name__ == '__main__':
    ...
    keywords = ['M flow', 'ทางพิเศษ', 'มอร์เตอร์เวย์', 'พระราม 2', 'ประมูล', 'ใบขับขี่', 'ต่อใบขับขี่', 'รถไฟฟ้า',
                'BTS', 'สถานีกลาง', 'สถานีกลางบางซื่อ', 'รถไฟความเร็วสูง', 'รถไฟรางคู่', 'ล้มประมวล', 'ฮั๊วประมูล',
                'เงินทอน']
    ...
    for url in urls:
        if url != 'N/A':
            news.append(parse_news(url))

    with open('news_daily.json', 'w', encoding='utf-8') as f:
